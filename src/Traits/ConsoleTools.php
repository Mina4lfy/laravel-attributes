...
/**
 * Copied from the `rinvex/laravel-support` package, as it cannot be installed as a dependency
 * for the `rinvex/laravel-attributes` package due to conflicts with other dependencies.
 *
 * @see https://github.com/rinvex/laravel-support/blob/master/src/Traits/ConsoleTools.php
 */
trait ConsoleTools
{
    /**
